...
export const AdminInviteMail = (firstName : string, lastName : string) => {
        ...
        <tr style="width:100%">
          <td>
            <table align="center" width="100%" border="0" cellPadding="0" cellSpacing="0" role="presentation" style="padding:0 48px">
              <tbody>
                <tr>
                  <td><img alt=${COMPANY_NAME}${firstName}${lastName} height="21" src="https://react-email-demo-7qy8spwep-resend.vercel.app/static/stripe-logo.png" style="display:block;outline:none;border:none;text-decoration:none" width="49" />
                    <hr style="width:100%;border:none;border-top:1px solid #eaeaea;border-color:#e6ebf1;margin:20px 0" />
                    <p style="font-size:16px;line-height:24px;margin:16px 0;color:#525f7f;text-align:left">Hello ,<br>
                    Thanks for submitting your account information. You&#x27;re now ready to move effortlessly  with ${amount}!</p>
